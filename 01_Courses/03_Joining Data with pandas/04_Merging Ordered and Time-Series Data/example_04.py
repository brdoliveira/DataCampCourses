...
# This method will unpivot a table from wide to long format. This is often a much more 
# computer-friendly format, therefore making this a valuable method to know.
social_fin_tall = social_fin.melt(id_vars=['financial','company'],
